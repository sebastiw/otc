...
| NAS EPS | 3GPP TS 24.301 v16.8.0        | /      | /      |                                   | Parameters might be binary decoded (i.e. passthrough) |
| NAS 5GS | 3GPP TS 24.501 v16.10.0       | /      | /      |                                   | Parameters might be binary decoded (i.e. passthrough) |
| SGSAP   | 3GPP TS 29.118 v16.0.0        |        |        |                                   |                                                  |
| GTPv1-C | 3GPP TS 29.060 v17.3.0        | X      |        |                                   | Parameters might be binary decoded (i.e. passthrough) |
| GTPv2-C | 3GPP TS 29.274 v17.7.0        | X      |        |                                   | Parameters might be binary decoded (i.e. passthrough) |
