...
|           217 | TLV    | UE Usage Type                                                     |   7.7.117 | Variable    |              4-n |
...
| Routeing Area Identity                   | Optional             |     7.7.3 |
...
| SGSN Address for user traffic            | Mandatory            |    7.7.32 |
...
| GGSN Address for user traffic              | Conditional          |    7.7.32 |
| Alternative GGSN Address for Control Plane | Conditional          |    7.7.32 |
| Alternative GGSN Address for user traffic  | Conditional          |    7.7.32 |
...
| Alternative SGSN Address for User Traffic  | Conditional          |    7.7.32 |
| Quality of Service Profile                 | Mandatory            |    7.7.34 |
| TFT                                        | Optional             |    7.7.36 |
| Trigger Id                                 | Optional             |    7.7.41 |
| OMC Identity                               | Optional             |    7.7.42 |
...
| Information element            | Presence requirement | Reference |
|--------------------------------+----------------------+-----------|
| Routeing Area Identity         | Mandatory            |     7.7.3 |
